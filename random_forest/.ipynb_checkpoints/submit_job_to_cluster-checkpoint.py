...
# Requires autoscaling to be created first:
        ...
        'config': {
            'gceClusterConfig': {
                ...
                "metadata": {
                    ...
                    'PIP_PACKAGES': 'scikit-learn==0.22.0'
                }
            },
            "softwareConfig": {
                'imageVersion': '1.4',
            ...
            'autoscalingConfig': {
                'policyUri': 'https://www.googleapis.com/compute/v1/projects/w261-final-project-259700/regions/global/autoscalingPolicies/autoscaling-policy'
            }
        }
    }
    ...
    job_details = {
        ...
        'job': {
            ...
            'pysparkJob': {
                ...
                'jarFileUris': ['gs://spark-lib/bigquery/spark-bigquery-latest.jar','gs://hadoop-lib/bigquery/bigquery-connector-hadoop2-0.13.9.jar'],
                'properties': {'spark.driver.maxResultSize': '8G', 'spark.driver.memory': '20G'}
                #'properties': {'spark.driver.memory': '20G','spark.executor.memory': '8G', 'spark.driver.maxResultSize': '2G',
                #    'spark.network.timeout': '5000000', 'spark.executor.heartbeatInterval': '1000000', 'spark.yarn.executor.memoryOverhead': '5G'},
                #'args':['--jars',['gs://spark-lib/bigquery/spark-bigquery-latest.jar','gs://hadoop-lib/bigquery/bigquery-connector-hadoop2-latest.jar']]
            }
        }
    }
